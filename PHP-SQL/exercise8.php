                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="ml-4">
                                                ...
                                                $sql = "SELECT last_name, first_name, gender, CAST(NOW() as date) as tee, STR_TO_DATE(birth_date, '%d/%m/%Y') as format_birth, ROUND(DATEDIFF(NOW(), STR_TO_DATE(birth_date, '%d/%m/%Y')) /365.25) as diff FROM users";
